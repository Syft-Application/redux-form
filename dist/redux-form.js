          ...
          function createConnectedField(structure) {
            ...
            var connector = (0, _reactRedux.connect)(
              function(state, ownProps) {
                ...
                var value = formState ? getIn(formState, 'values.' + name) : initial
            ...
            var connector = (0, _reactRedux.connect)(
              function(state, ownProps) {
                ...
                var initial =
                  ...
                  (initialValues && getIn(initialValues, name))
                var value = getIn(formState, 'values.' + name) || initial
                var submitting = getIn(formState, 'submitting')
                var syncError = getSyncError(getIn(formState, 'syncErrors'), name)
                var syncWarning = getSyncWarning(getIn(formState, 'syncWarnings'), name)
                var pristine = deepEqual(value, initial)
              ...
              return function(WrappedComponent) {
                ...
                var connector = (0, _reactRedux.connect)(
                  function(state, props) {
                    ...
                    var initial = initialValues || stateInitial || empty // if (!shouldUpdateInitialValues) {
